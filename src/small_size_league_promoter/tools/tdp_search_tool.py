...
class TDPResultParagraph(BaseModel):
    ...
    tdp_name: Optional[TDPInfo] = Field(..., description="The TDP name information including league and team details.")
    ...
    questions: Optional[List[str]] = Field(default_factory=list, description="List of questions related to the paragraph content.")

class TDPResult(BaseModel):
    """Response type for TDPSearchTool."""
    keywords: Optional[List[str]] = Field(default_factory=list, description="The keywords found in the TDP.")
    paragraphs: Optional[List[TDPResultParagraph]] = Field(default_factory=list, description="The paragraphs found in the TDP.")
